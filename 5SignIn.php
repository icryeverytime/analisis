...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="CSS/5SignIn.css">
  ...
  <body>
   <header>
    ...
    <!-- multistep form -->
    <form id="msform" method="POST" action="insertarcliente.php">
       <!-- fieldsets -->
      <fieldset>
        ...
        <h3 class="fs-subtitle">Already have an account? <a href="6LogIn.php">Login</a></h3>
