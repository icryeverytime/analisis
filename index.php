...
if( $_GET['action'] == 'success' ) {
  echo "<script>alert('Factura generada');</script>";
}
?>
...
<header>
    ...
    <br>
    <div class="text">
        <h3 class="text1"> <b>SHOP OUR BEST DEALS ONLINE</b></h3>
        <h2 class="text2">WiFI. Entertainment. Your Way.</h2>
        <h4 class="text3"><b>Featured deal:</b> save on fast internet on the largest gig-speed <br>
        network. Enjoy 10+ channel of local news, live sports and <br>
        more, on any screen with the Xfinity Stream app. Plus <br>
        costumize with channel packs</h4>
        <h1 class="text4">$55/mo for 12 months with no term agreement.</h1>
    </div>
